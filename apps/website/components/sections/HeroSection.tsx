...
export async function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative z-10 flex-1 flex flex-col justify-start md:justify-center px-4 md:px-8 max-w-screen-xl mx-auto w-full pb-24 md:pb-12 pt-[calc(var(--nav-height)+env(safe-area-inset-top)+1rem)] md:pt-[calc(var(--nav-height)+env(safe-area-inset-top)+2.5rem)]"
      >
