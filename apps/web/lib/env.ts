...
export const env = createEnv({
  server: {
    ...
    NETCASH_SERVICE_KEY: z.string().min(1),
    NETCASH_WEBHOOK_SECRET: z.string().min(1),
    NETCASH_API_URL: z.string().url(),
    BULKSMS_USERNAME: z.string().min(1),
    BULKSMS_PASSWORD: z.string().min(1),
