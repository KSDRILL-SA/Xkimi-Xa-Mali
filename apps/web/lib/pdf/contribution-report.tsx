          ...
          <View style={s.closeRow}>
            <View style={s.notes}>
              ...
              <Text style={s.notesText}>
                This report summarises group contribution activity for {period.label} on the Xkimi Xa Mali Foundation
